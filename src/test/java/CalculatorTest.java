...
import static org.junit.Assert.assertNotEquals;
    ...
    public class CalculatorTest {
        ...
        public void squareRootPositive() {
            assertEquals("Testing True : squareRoot of a positive number", 5.0, c.squareRoot(25.0), delta);
            assertEquals("Testing True : squareRoot of a negative number", Double.NaN, c.squareRoot(-25.0), delta);
            assertEquals("Testing True : squareRoot of 0", 0.0, c.squareRoot(0.0), delta);
        }

        @Test
        public void squareRootNegative() {
            assertNotEquals("Testing False : squareRoot of a positive number", Double.NaN, c.squareRoot(16.0), delta);
            assertNotEquals("Testing False : squareRoot of a negative number", 4.0, c.squareRoot(-16.0), delta);
